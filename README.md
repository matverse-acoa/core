...
```bash
bash scripts/install_signing_hooks.sh
git config --global gpg.format ssh
git config --global commit.gpgsign true
git config --global user.signingkey .git/matverse/commit_signing_ed25519.pub
```

**Chaves locais (repo):**
```
.git/matverse/commit_signing_ed25519
.git/matverse/commit_signing_ed25519.pub
```
