...
def analyze(req: GateRequest):
    ...
    checks = [
        ...
        {"rule": "theta_p95<=100ms", "ok": theta_p95_ms <= 100.0, "value": theta_p95_ms},
    ...
    pose = {
        ...
        "governance": {
            "features": {
                ...
                "cvar.v1": {"alpha": 0.95, "value": cvar, "one_minus": one_minus_cvar},
                "pole.v1": {"value": pole},
                "hidden_residual.v1": {
                    "value": residual,
    ...
    # Persistência
    ledger.append("GATE_DECISION", {"evidence_id": evidence_id, "verdict": verdict, "omega": omega})
